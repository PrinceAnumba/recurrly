...
export default function App() {
    return (
        <SafeAreaView className="flex-1 p-5 bg-background ">
            ...
            <Link href="/(auth)/sign-up" className=" mt-4 rounded bg-primary text-white p-4">Spotify Subscription</Link>
            <Link href={{ pathname: "/subscriptions/[id]", params: { id: 'Claude' }}}  className=" mt-4 rounded bg-primary text-white p-4">Go to Sign Up</Link>
        </SafeAreaView>
    );
}